...
- Hero greeter distribution beat direction: Iris should draft HN-primary + Twitter + r/ClaudeCode follow-up for 2026-06-16/17 if draft/logging/submitter are ready. Pre-HN gates: attempts/runbook row-writing wired, Olivia adversarial smoke PASS, and Hestia burst-capacity read PASS by 06-13 (>=95% success at N=50, P95 <30s, no silent hangs). Frame as “homepage you can talk to” / replayable identity+messaging demo, not E2EE or broad interoperability; P3-primary proof while P1 priority remains unchanged.
