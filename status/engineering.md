# Engineering Status
Last updated: 2026-05-20 18:45 GMT
...
- **aweb-aaph — product-authority simplification epic**: new P0 successor created by Athena after Grace landed product-authority SOT clarifications at aweb `8004485`; live children `.1`-`.7` exist and are unassigned. Scope is code/UX deletion and exact authority-boundary tests: no hosted-local browser/MCP product shape, hosted custodial creation global-only, local self-custodial CLI/API-key preserved, mixed-custody teams through current team authority certs, BYOT custodial pending/import fail-closed.
