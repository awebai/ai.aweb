...
forward migration.** Canonical statement and recovery patterns in
`aweb/docs/aweb-sot.md` "Migrations" section. Cross-references this
because reviewing diffs is where engineering catches violations
(every dev-facing schema change touches this discipline).
