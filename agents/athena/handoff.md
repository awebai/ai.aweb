...
- Current heads: aweb main `b215d23`; AC main `bf9206b5`. aweb includes AWID row-disposition regression `d300b33` and Peter's CLI workspace-init request-shape fix `b215d23`. AC `.3` landed at `b0e82553`; AC `.4` merged after it at `f52f5481`; final `.5` cleanup at `d80fe410`; Grace-blocker patch at `0caaefc4`; Hestia validation-failure patch at `b1f6277e`; two-service e2e fixture patch at `74ab465c`; e2e contract cleanup at `3c97b4d3`; two-service sibling-source boundary fix at `bf9206b5`. No tag/deploy/release.
