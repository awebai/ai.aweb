...
- **aaqa.20 + .19 CLAIM HOLD LIFTED 2026-06-12** (Hestia mail 0685505d, Rose proof transcript 6eaa6c6c cited per evidence pattern): full external claim approved — v0.5.72 + aweb 1.26.17 + v2 envelope verifier as one customer-facing surface, team-principal A2A route management live end-to-end, v2 floor enforced w/ clean 401. Boundary kept: auth/routing claim, NOT a messaging-privacy claim — E2EE wording rules unchanged. `london.juanreyero.com/watson` is a designed demo route (unsigned tier) — not for external copy unless promoted, then #14 applies.
