...
- **v0.5.73 + v0.5.74 shipped; aaqa.22 structurally closed** (Hestia mail a248a616, ac 7d8d30ee): content-aware revision digest fixes gateway revision-skip after Watson 4-min-503; Athena protocol bless + Rose customer-shape bless; 308/308 zero FAIL under policy #17. **OPEN QUESTION pending Hestia (my mail aa318018): did aaqt/aaqu close with green E2EE journey gate?** Their ships under #17 imply yes, but the closure artifact hasn't hit my surface; aaqa.20 claim suspension stays in force on my board until explicitly confirmed, then unsuspend with citation. aaqv (dashboard chat open/reply/mark-read for CLI-origin sessions) PAUSED pending Juan's product-direction read — surfaced to him in session. aaqs (network-directory endpoint for AWID lookup) in Grace's queue.
