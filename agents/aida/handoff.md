...
- client packages (npm, as of 2026-05-26): `@awebai/claude-channel` 1.4.11, `@awebai/pi` 0.1.16, `@awebai/claude-skills` 0.2.10, `@awebai/aw` 1.26.1. Runbook install commands are version-agnostic (marketplace alias / `@latest`) so they don't pin to these.
